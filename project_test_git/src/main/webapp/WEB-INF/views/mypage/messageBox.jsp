				...
				<table class="table table-hover table-mail">
					<tbody>
						<tr>
							...
							<th width=20%><label>보낸 이</label></th>
						...
						<c:forEach var="m" items="${message}">
							<tr>
								...
								<td class="mail-ontact">${m.sender}</td>
								<td class="mail-subject"><a href="">${m.message_content}</a></td>
								<td><fmt:formatDate value="${m.date_of_receiving}"
										pattern="yyyy-MM-dd HH:mm:ss" /></td>

								<td><a href="deleteMSG.htm?message_num=${m.message_num}"> <input type="hidden"
