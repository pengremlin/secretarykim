		...
		<ul class="nav metismenu" id="side-menu">
			...
			<li><a href=""><i class="fa fa-star"></i> <span
				...
				<ul class="nav nav-second-level">
					<li class="active"><a href="${pageContext.request.contextPath}/company/company.htm">My Company<span
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding: 40px 50px;">
						...
						<div class="form-group">
							<label for="psw"><span class="glyphicon glyphicon-phone"></span>사원
								번호</label> <input type="text" class="form-control" id="emp_no"
								name="emp_no" placeholder="처음 부여될 사원 번호입니다.">
						</div>
						<div class="form-group">
							<label for="psw"><span
