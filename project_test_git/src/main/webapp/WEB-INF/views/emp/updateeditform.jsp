							...
							<c:forEach var="list" items="${emplist}">
								...
								<%-- 	<td style="text-align: center; vertical-align: middle">${list.user_gender}</td>
									...
									<td style="text-align: center; vertical-align: middle">
										<button name="delemp-${list.user_id}" value="${list.user_id}"
											class="btn btn-info" data-toggle="modal"
											data-target="#subuserDialog">권한 삭제</button>
									</td>
								</tr>
							</c:forEach>
						</tbody>
...
<div class="modal inmodal fade inl" id="subuserDialog" tabindex="-1"
	...
	<form name="subuserlist"
		action="${pageContext.request.contextPath}/emp/deleteSubmit.htm"
		method="post">
					...
					<div id="userBody">
						...
						<table>
							...
							<tr>
								...
								</select><input type="hidden" id="auth_list_selected" name="auth_name">
							</tr>
							<%-- <tr>
								<th>권한 삭제</th>
						...
						<button style="margin-top:20px;" type="submit" id="job_button"
							class="btn btn-primary btn-block">권한 삭제</button>
