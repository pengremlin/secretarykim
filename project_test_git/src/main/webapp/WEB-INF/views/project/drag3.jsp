					...
					<div class="modal-body">
						<div class="note-editable" contenteditable="true">
							...
							<input type="hidden" id="project_no" name="project_no"
								value="${list[0].project_no }"> <input type="hidden"
								id="list_name" name="list_name" value="${list[0].list_name }">
	...
	<div class="modal inmodal fade in" id="myModal2" tabindex="-1"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content animated flipInY">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-white" data-dismiss="modal">닫기</button>
					<button id="btn_re" class="btn btn-primary">내용 저장</button>
				</div>
			</div>
		</div>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-title">
						<table class="table table-striped">
							<thead>
								<tr>
									<th><button class="btn btn-success btn-md"
											style="float: right;" id="finish_agile"  >
											<i class="fa fa-thumb"></i>완료
										</button></th>
								</tr>
							</thead>
							<tbody>
								...
								<c:forEach var="b" items="${board_list}">
									<c:if test="${b.list_no=='1'}">
										<li class="색깔을 정하는 클래스" id="${b.board_no}">
											...
											<div class="agile-detail">
												<a href="#" class="pull-right btn btn-xs btn-white"
													id="delete_board-" +${b.board_no} name="${b.board_no}"
													style="background-color: #1AB394; color: white;">삭제하기</a> <a
