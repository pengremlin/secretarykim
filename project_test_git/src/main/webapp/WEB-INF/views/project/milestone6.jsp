						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=1">성숙도
									체크</a></li>
								<li><a id="file_upload-1"  data-toggle="modal" data-target="#fileuploadModal">파일 업로드하기</a></li>
								<li><a id="file_download-1"  data-toggle="modal" data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=2">성숙도
									체크</a></li>
							<li><a id="file_upload-2" data-toggle="modal" data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-2"  data-toggle="modal" data-target="#filedownloadModal">파일 다운로드 하기</a></li>		
						</ul></li>
				</ul>
			</td>
		</tr>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=3">성숙도
									체크</a></li>
							<li><a id="file_upload-3" data-toggle="modal" data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-3"  data-toggle="modal" data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
		</tr>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=4">성숙도
									체크</a></li>
							<li><a id="file_upload-4" data-toggle="modal" data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-4"  data-toggle="modal" data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
		</tr>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=5">성숙도
									체크</a></li>
							<li><a id="file_upload-5" data-toggle="modal" data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-5"  data-toggle="modal" data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
		</tr>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=6">성숙도
									체크</a></li>
							<li><a id="file_upload-6" data-toggle="modal" data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-6"  data-toggle="modal" data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
		</tr>
