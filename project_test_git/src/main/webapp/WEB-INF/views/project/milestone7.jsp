	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content animated flipInY">
			<div class="modal-header" id="modal-header">
				...
				<h4 class="modal-title" id="title">행 이름 설정하기</h4>
				<small class="font-bold"></small>
			</div>
			<div class="modal-body">
...
<div class="modal inmodal fade inl" id="fileuploadModal" tabindex="-1"
	...
	<div class="modal-dialog">
		<div class="modal-content animated flipInY">
			...
			<div class="modal-body">
				<form action="uploadpro_File.htm" method="post" id="uploadFile"
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td colspan="1"><input type="text" name="data_content"
								placeholder="파일에 대한 설명"></td>
						</tr>
						<tr align="center">
							<td colspan="2">
								...
								</button> <input type="hidden" id="for_file_project_no"
								value="${project_no }" name="project_no"> <input
								type="hidden" id="for_file_col_no" name="mile_col_no">
	...
	<div class="modal-dialog">
		<div class="modal-content animated flipInY">
			...
			<div class="modal-body">
				...
				<input type="hidden" id="for_download_project_no"
					value="${project_no }" name="project_no">
	...
	<table class="table table-striped">
		<tr>
			<td valign="middle" rowspan="1" colspan="1" align="center">알파상태
				배열하기 <i class="fa fa-hand-o-right"></i>
			</td>
					...
					<li class="dropdown"><a class="dropdown-toggle count-info"
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a id="edit_col_button1" data-toggle="modal"
								data-target="#colModal">행 이름 설정하기</a></li>
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=1">성숙도
									체크</a></li>
							<li><a id="file_upload-1" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-1" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=2">성숙도
									체크</a></li>
							<li><a id="file_upload-2" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-2" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=3">성숙도
									체크</a></li>
							<li><a id="file_upload-3" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-3" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=4">성숙도
									체크</a></li>
							<li><a id="file_upload-4" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-4" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
						...
						<ul class="dropdown-menu dropdown-user">
							...
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=5">성숙도
									체크</a></li>
							<li><a id="file_upload-5" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-5" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
		...
		<tr>
			...
			<td colspan="1" align="center">
				<ul class="sortable-list stakeholder agile-list" id="stakeholder6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'stakeholder6'}">
							<li class="success-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list opportunity agile-list" id="opportunity6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'opportunity6'}">
							<li class="success-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list requirements agile-list" id="requirements6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'requirements6'}">
							<li class="warning-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list softwaresystem agile-list"
					id="softwaresystem6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'softwaresystem6'}">
							<li class="warning-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list team agile-list" id="team6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'team6'}">
							<li class="info-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list wayofworking agile-list" id="wayofworking6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'wayofworking6'}">
							<li class="info-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list work agile-list" id="work6">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'work6'}">
							<li class="info-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="nav navbar-top-links navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle count-info"
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a id="edit_col_button6" data-toggle="modal"
								data-target="#colModal">행 이름 설정하기</a></li>
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=6">성숙도
									체크</a></li>
							<li><a id="file_upload-6" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-6" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
		...
		<tr>
			...
			<td colspan="1" align="center">
				<ul class="sortable-list stakeholder agile-list" id="stakeholder7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'stakeholder7'}">
							<li class="success-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list opportunity agile-list" id="opportunity7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'opportunity7'}">
							<li class="success-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list requirements agile-list" id="requirements7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'requirements7'}">
							<li class="warning-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list softwaresystem agile-list"
					id="softwaresystem7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'softwaresystem7'}">
							<li class="warning-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list team agile-list" id="team7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'team7'}">
							<li class="info-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list wayofworking agile-list" id="wayofworking7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'wayofworking7'}">
							<li class="info-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="sortable-list work agile-list" id="work7">
					<c:forEach var="b" items="${alph_title}">
						<c:if test="${b.alph_loc eq 'work7'}">
							<li class="info-element" id="${b.alph_title}">
								<div class="success-element">
									<a href="#" class="pull-right btn btn-xs btn-white"
										data-toggle="modal" data-target="#myModal"
			...
			<td colspan="1" align="center">
				<ul class="nav navbar-top-links navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle count-info"
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a id="edit_col_button7" data-toggle="modal"
								data-target="#colModal">행 이름 설정하기</a></li>
							<li><a
								href="milestone_score.htm?project_no=${project_no }&col_no=7">성숙도
									체크</a></li>
							<li><a id="file_upload-7" data-toggle="modal"
								data-target="#fileuploadModal">파일 업로드하기</a></li>
							<li><a id="file_download-7" data-toggle="modal"
								data-target="#filedownloadModal">파일 다운로드 하기</a></li>
						</ul></li>
				</ul>
			</td>
